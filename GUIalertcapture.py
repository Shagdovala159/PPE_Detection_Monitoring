...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.CaptureIpCameraFramesWorker_1.warningSignal.connect(self.showWarning)
        ...
        self.CaptureIpCameraFramesWorker_2.warningSignal.connect(self.showWarning)
        ...
        self.CaptureIpCameraFramesWorker_3.warningSignal.connect(self.showWarning)
        ...
        self.CaptureIpCameraFramesWorker_4.warningSignal.connect(self.showWarning)
